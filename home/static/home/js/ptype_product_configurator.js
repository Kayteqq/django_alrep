        ...
        schemeLAngle(widthG, widthE, widthH, angleAlfa)
        {
            ...
            return `
                <svg class="configurated"  
                    ...
                    <text x="${SHAPE_START_X + widthE + (0.5 * widthH) - 4}" y="${SHAPE_START_Y - MEASUREMENT_MARGIN - 1}" font-size="10" font-family="sans-serif" transform="rotate(${180-angleAlfa} ${SHAPE_START_X + widthE} ${SHAPE_START_Y})">H</text> 
                    ...
                    <text x="${SHAPE_START_X + positionGLabel + (0.5 * MEASURING_LINE_LENGTH)}" y="${SHAPE_START_Y}" font-size="10" font-family="sans-serif" transform="rotate(-90 ${SHAPE_START_X + positionGLabel} ${SHAPE_START_Y})">g</text> 
...
<!--                                        E - text-->
                    ...
                    <text x="${SHAPE_START_X + (0.5 * widthE) - 2 + widthA * Math.sin(betaRadians)}" y="${SHAPE_START_Y + widthH  + MEASUREMENT_MARGIN + widthA * Math.cos(betaRadians)- 0.5}" font-size="10" font-family="sans-serif">E</text> 
...
<!--                                        H - text -->
                    ...
                    <text x="${SHAPE_START_X + widthE + widthA * Math.sin(betaRadians) - widthH * 0.5 - 5}" y="${SHAPE_START_Y + widthA * Math.cos(betaRadians) - widthG + MEASUREMENT_MARGIN + 8} " font-size="10" font-family="sans-serif" transform="rotate(${ - angleAlfa} ${SHAPE_START_X + widthE + widthA * Math.sin(betaRadians)} ${SHAPE_START_Y + widthA * Math.cos(betaRadians) - widthG})">H</text> 
...
<!--                                        A - text -->
                    ...
                    <text x="${SHAPE_START_X - 2.5 - widthA * 0.5}" y="${SHAPE_START_Y - MEASUREMENT_MARGIN - 1}" font-size="10" font-family="sans-serif" transform="rotate(${-angleBeta} ${SHAPE_START_X} ${SHAPE_START_Y})">A</text> 
...
<!--                    E - txt -->
                    ...
                    <text x="${SHAPE_START_X + widthA * Math.sin(betaRadians) + widthE*0.5 - 2}" y="${left ? SHAPE_START_Y + smaller * Math.cos(betaRadians) + difference + MEASUREMENT_MARGIN - 0.5 : SHAPE_START_Y + bigger * Math.cos(betaRadians) + MEASUREMENT_MARGIN - 0.5}" font-size="10" font-family="sans-serif">E</text>
